        ...
        @if (loadingRenewals) {
          ...
          <div class="requests-grid">
            @for (req of renewals; track req.id) {
              <div class="expert-request-card">
                <div class="card-left">
                  <div class="status-indicator-bar" [ngClass]="getStatusClass(req.status)" style="width: 100%; margin-bottom: 0.5rem;">
                    {{ req.status }}
                  </div>
                  <div class="request-meta">
                    ...
                    <h3>{{ req.vehicle?.make }} {{ req.vehicle?.model }} ({{ req.vehicle?.registrationNumber }})</h3>
                    <div class="info-row">
                ...
                <div class="card-right" style="display: flex; flex-direction: column; gap: 0.5rem;">
