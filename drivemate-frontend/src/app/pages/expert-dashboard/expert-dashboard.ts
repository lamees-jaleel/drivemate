...
import { ExpertRenewalService } from '../../services/expert-renewal.service';
...
export class ExpertDashboard
  ...
  private readonly toast =
    ...
    private readonly renewalService = inject(ExpertRenewalService);
