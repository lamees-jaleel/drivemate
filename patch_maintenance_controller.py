...
file_path = "c:/Drivemate/drivemate-backend/src/controllers/maintenance.controller.ts"
...
if "updateMaintenanceRecord" not in content:
    content += new_funcs

with open(file_path, "w", encoding="utf-8") as f:
    f.write(content)

print("Patched maintenance controller")
